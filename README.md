...
The service(CityService) class contains the main logic of the application:
Data parsing, retrieving all city names and weather data.

### Model

The model(City) contains the fillable data for the database 
and the method for updating the data.
